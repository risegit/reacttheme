    ...
    <section className="relative pb-14 pt-28 md:pb-16 md:pt-32 lg:pb-[88px] lg:pt-44 xl:pb-[100px] xl:pt-[200px]">
      ...
      <div className="container">
        <div className="text-center">
          ...
          <RevealWrapper as="h5">
            Businesses rarely struggle because they lack marketing tools. They struggle because their digital marketing
            efforts are fragmented.
          </RevealWrapper>
          <RevealWrapper as="h5">
            Rise IT helps businesses solve core digital growth challenges through integrated marketing systems combining
            SEO, performance marketing, social media marketing, digital PR, conversion optimisation, website
