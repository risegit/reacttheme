...
const SolutionV3 = () => {
  ...
  return (
    <section
      ref={triggerRef}
      className="service-section overflow-hidden pb-14 pt-14 md:pb-16 md:pt-16 lg:pb-[88px] lg:pt-[88px] xl:pb-[100px] xl:pt-[70px] relative"
    ...
    >
          ...
          <div className="col-span-12 lg:col-span-7">
            <TextAppearAnimation>
              <h2 className="text-appear text-left text-secondary dark:text-secondary max-md:text-3xl max-sm:text-3xl">
                What We Do{' '}
                <span className="font-instrument italic text-secondary dark:text-secondary">
                  Our work includes:
                </span>
              </h2>
            </TextAppearAnimation>
      ...
      <div className="horizontal-scroll-container relative mt-16 md:mt-24">
        <div
          ref={contentRef}
          className="service-wrapper flex flex-col gap-6 md:flex-row md:flex-nowrap md:pl-[calc(5%+20px)] lg:md:pl-[calc(10%+30px)] xl:pl-[15%]"
        ...
        >
          {data.map((item) => (
            <Link
              ...
              className="group block w-full flex-shrink-0 transition-transform duration-300 hover:-translate-y-1 md:w-[370px]"
            >
              <div className="flex w-full flex-1 flex-col gap-4 rounded-none border-t border-t-secondary bg-backgroundBody px-5 py-14 dark:border-t-primary dark:bg-black md:flex-row md:gap-[22px] md:px-[25px] md:py-[70px] transition-all duration-300 hover:bg-gray-50 dark:hover:bg-gray-900">
