  ...
  return (
    <section
      ...
      <div id="hero-gradient-wrapper" className="absolute left-0 top-0 -z-10 blur-[65px]" aria-hidden="true">
        <img src="/images/hero-gradient-background.png" alt="hero" id="hero-gradient" className="left-0 top-0" />
      </div>
      ...
      <div className="mx-auto max-w-[1600px] px-6 md:px-14">
        ...
        <RevealWrapper className="flex flex-col gap-y-10 xl:flex-row xl:justify-between">
          ...
          <div className="flex-1">
            ...
            {/* 3 POINTS */}
            <ul className="mt-6 list-disc space-y-3 pl-5 marker:text-base marker:text-neutral-800">
        ...
        <RevealWrapper className="mt-10 max-w-[1100px] space-y-6 text-sm leading-relaxed text-neutral-600">
          <p>
            Businesses often try to solve these problems independently. SEO happens separately from advertising. Social
            media operates without a clear role in lead generation. Websites attract traffic but fail to convert
            visitors.
          </p>

          <p>Our approach focuses on connecting these elements into a structured marketing system.</p>

          <p>
            Visibility ensures the right audience can find your business. Demand generation brings qualified prospects
            to your digital platforms. Conversion ensures that attention turns into real enquiries and opportunities.
          </p>

          <p>When these three elements work together, marketing becomes a growth system.</p>
        </RevealWrapper>
      </div>
    </section>
  )
